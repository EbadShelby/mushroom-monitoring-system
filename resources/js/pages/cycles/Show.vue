...
function buildAvgChart(
    key: 'avg_temperature' | 'avg_humidity' | 'avg_co2' | 'avg_light',
    color: string,
) {
    ...
    return {
        ...
        series: [
            {
                name: key.replace('avg_', '').replace('_', ' '),
                data: avgs.map((r) => r[key] ?? 0),
            },
        ],
    };
}
...
const breachCards = computed(() => [
    {
        label: 'Temperature',
        value: props.breachSummary?.temperature ?? 0,
        range: '24–30°C',
        icon: Thermometer,
    ...
    {
        label: 'Humidity',
        value: props.breachSummary?.humidity ?? 0,
        range: '≥ 80%',
        icon: Droplets,
        color: 'text-cyan-400',
        bg: 'bg-cyan-500/10',
    ...
    {
        label: 'CO₂',
        value: props.breachSummary?.co2 ?? 0,
        range: '≤ 1000ppm',
        icon: Wind,
    ...
    {
        label: 'Soil Moisture',
        value: props.breachSummary?.soil_moisture ?? 0,
        range: '≥ 30%',
        icon: Leaf,
        ...
        <div>
            ...
            >
                <div class="flex items-start gap-4">
                    <div
                        class="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-emerald-500/10"
                    >
        ...
        >
            ...
            <div v-else class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                >
                    ...
                    <VueApexCharts
                        :options="humChart.options"
                        :series="humChart.series"
                        height="140"
                    />
                </div>
                <div
                ...
                >
                    ...
                    <VueApexCharts
                        :options="co2Chart.options"
                        :series="co2Chart.series"
                        height="140"
                    />
                </div>
                <div
                ...
                >
                    ...
                    <VueApexCharts
                        :options="lightChart.options"
                        :series="lightChart.series"
                        height="140"
                    />
                </div>
            </div>
                        ...
                        >
                            ...
                            <td class="py-3 pr-4">
                                <span
                                    ...
                                    >Flush {{ m.flush_number }}</span
                                >
                            </td>
                            <td
                                class="py-3 pr-4 font-mono font-bold text-emerald-400"
                            >
                                {{ m.weight_g ?? '—' }}
                            </td>
                            <td class="py-3 pr-4 text-slate-300">
                ...
                <div v-for="group in groupedSnapshots" :key="group.date">
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <div
                                class="absolute inset-0 flex items-end bg-gradient-to-t from-black/60 to-transparent opacity-0 transition group-hover:opacity-100"
                            >
                                <div class="p-2">
                                    <p
                    ...
                    >
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    v-model.number="
                                        measureForm.fruiting_body_count
                                    "
                                    type="number"
                                    min="0"
                                    placeholder="0"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                >
                                <input
                                    v-model="measureForm.cap_diameter_cm"
                                    type="number"
                                    step="0.1"
                                    min="0"
                                    placeholder="0.0"
