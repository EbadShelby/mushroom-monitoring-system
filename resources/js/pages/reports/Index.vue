...
<template>
    ...
    <div class="space-y-6">
        ...
        >
            ...
            <div class="relative w-full sm:w-64">
                ...
                <input
                    ...
                    class="w-full rounded-xl border border-slate-700 bg-slate-800/50 py-2 pr-4 pl-10 text-sm text-white placeholder-slate-500 focus:border-emerald-500 focus:outline-none"
                />
            </div>
        </div>
        ...
        <div
            ...
            class="flex flex-col items-center justify-center rounded-2xl border border-slate-700/50 bg-slate-800/50 py-20 text-center backdrop-blur-sm"
        >
            <div
        ...
        <div v-else class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div
                ...
                :key="cycle.id"
                class="flex flex-col rounded-2xl border border-slate-700/50 bg-slate-800/50 p-5 shadow-sm backdrop-blur-sm transition-all hover:bg-slate-800/80 hover:shadow-lg"
            >
                <!-- Card Header -->
                <div class="mb-4 flex items-start justify-between">
                    <div>
                        <h3
                            class="line-clamp-1 font-bold text-white"
                            :title="cycle.name"
                        >
                            {{ cycle.name }}
                        </h3>
