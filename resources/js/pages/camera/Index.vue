...
const filterCycle = ref<string>(
    props.filters.cycle_id ? String(props.filters.cycle_id) : '',
);
...
const uploadForm = ref({
    growing_cycle_id: props.filters.cycle_id
        ? String(props.filters.cycle_id)
        : '',
    flush_number: '1',
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <!-- Overlay -->
                        <div
                            class="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-black/70 via-transparent to-transparent p-2 opacity-0 transition duration-200 group-hover:opacity-100"
                        >
                            <span
                    ...
                    <form class="space-y-4 p-6" @submit.prevent="submitUpload">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p
                                    v-if="uploadErrors.growing_cycle_id"
                                    class="mt-1 text-xs text-red-400"
                                >
                                    {{ uploadErrors.growing_cycle_id }}
                                </p>
                            </div>
                            <div>
                                <label
    ...
    <Teleport to="body">
        ...
        >
            ...
            >
                ...
                <div
                    class="flex max-h-screen max-w-5xl flex-col items-center gap-3 p-4"
                    @click.stop
                >
                    <img
                        :src="`/storage/${lightboxSnap.file_path}`"
                        :alt="lightboxSnap.file_name"
