            ...
            <template v-else>
                ...
                <div>
                    ...
                    <p class="mt-1 text-muted-foreground">
                        Manage users, thresholds, and system configuration.
                    </p>
                </div>

                <!-- Tabs -->
                <div
                    class="flex flex-wrap gap-2 rounded-2xl border border-border/50 bg-card/60 p-2 backdrop-blur-md"
                >
                    <button
                        v-for="tab in tabs"
                        :key="tab.id"
                ...
                <div v-if="activeTab === 'thresholds'" class="space-y-6">
                    ...
                    <div
                        class="rounded-2xl border border-amber-500/20 bg-card/60 p-6 shadow-sm backdrop-blur-md"
                    >
                        <div class="mb-6 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-muted-foreground">
                                    Mycelium spawn running phase — warm, dark,
                                    high CO₂ tolerated
                                </p>
                            </div>
                        </div>
                        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                            <div class="space-y-1">
                                ...
                                <input
                                    id="col-temp-min"
                                    v-model="
                                        settingsForm.threshold_col_temp_min
                                    "
                                    type="number"
                                    step="0.1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                ...
                                <input
                                    id="col-temp-max"
                                    v-model="
                                        settingsForm.threshold_col_temp_max
                                    "
                                    type="number"
                                    step="0.1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                <label
                                    for="col-hum-low"
                                    class="text-xs font-medium tracking-wider text-muted-foreground uppercase"
                                    >Humidity Low — Humidifier ON (%)</label
                                >
                                <input
                                    id="col-hum-low"
                                    v-model="
                                        settingsForm.threshold_col_humidity_low
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                <label
                                    for="col-hum-high"
                                    class="text-xs font-medium tracking-wider text-muted-foreground uppercase"
                                    >Humidity High — Humidifier OFF (%)</label
                                >
                                <input
                                    id="col-hum-high"
                                    v-model="
                                        settingsForm.threshold_col_humidity_high
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                <label
                                    for="col-co2"
                                    class="text-xs font-medium tracking-wider text-muted-foreground uppercase"
                                    >CO₂ Max — Fan ON (ppm)</label
                                >
                                <input
                                    id="col-co2"
                                    v-model="settingsForm.threshold_col_co2_max"
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                                    placeholder="5000"
                            ...
                            <div class="space-y-1">
                                <label
                                    for="col-light-max"
                                    class="text-xs font-medium tracking-wider text-muted-foreground uppercase"
                                    >Light Max — Keep Dark (lux)</label
                                >
                                <input
                                    id="col-light-max"
                                    v-model="
                                        settingsForm.threshold_col_light_max
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                <label
                                    for="col-soil-warn"
                                    class="text-xs font-medium tracking-wider text-muted-foreground uppercase"
                                    >Substrate Moisture Warning (%)</label
                                >
                                <input
                                    id="col-soil-warn"
                                    v-model="
                                        settingsForm.threshold_col_soil_warning
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                <label
                                    for="col-soil-crit"
                                    class="text-xs font-medium tracking-wider text-muted-foreground uppercase"
                                    >Substrate Moisture Critical (%)</label
                                >
                                <input
                                    id="col-soil-crit"
                                    v-model="
                                        settingsForm.threshold_col_soil_critical
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                    ...
                    <div
                        class="rounded-2xl border border-purple-500/20 bg-card/60 p-6 shadow-sm backdrop-blur-md"
                    >
                        <div class="mb-6 flex items-center gap-3">
                            <div
                            ...
                            <div>
                                <h2 class="font-semibold text-purple-400">
                                    FRUITING STAGE THRESHOLDS
                                </h2>
                                <p class="text-xs text-muted-foreground">
                                    Mushroom formation phase — cooler, high
                                    humidity, fresh air, indirect light
                                </p>
                            </div>
                        </div>
                        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                            <div class="space-y-1">
                                ...
                                <input
                                    id="fruit-temp-min"
                                    v-model="
                                        settingsForm.threshold_fruit_temp_min
                                    "
                                    type="number"
                                    step="0.1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                ...
                                <input
                                    id="fruit-temp-max"
                                    v-model="
                                        settingsForm.threshold_fruit_temp_max
                                    "
                                    type="number"
                                    step="0.1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                ...
                                <input
                                    id="fruit-hum-low"
                                    v-model="
                                        settingsForm.threshold_fruit_humidity_low
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                ...
                                <input
                                    id="fruit-hum-high"
                                    v-model="
                                        settingsForm.threshold_fruit_humidity_high
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                ...
                                <input
                                    id="fruit-co2"
                                    v-model="
                                        settingsForm.threshold_fruit_co2_max
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                <label
                                    for="fruit-light-min"
                                    class="text-xs font-medium tracking-wider text-muted-foreground uppercase"
                                    >Light Min — Needs Indirect Light
                                    (lux)</label
                                >
                                <input
                                    id="fruit-light-min"
                                    v-model="
                                        settingsForm.threshold_fruit_light_min
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                <label
                                    for="fruit-light-max"
                                    class="text-xs font-medium tracking-wider text-muted-foreground uppercase"
                                    >Light Max — Too Bright (lux)</label
                                >
                                <input
                                    id="fruit-light-max"
                                    v-model="
                                        settingsForm.threshold_fruit_light_max
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                ...
                                <input
                                    id="fruit-soil-warn"
                                    v-model="
                                        settingsForm.threshold_fruit_soil_warning
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                            ...
                            <div class="space-y-1">
                                ...
                                <input
                                    id="fruit-soil-crit"
                                    v-model="
                                        settingsForm.threshold_fruit_soil_critical
                                    "
                                    type="number"
                                    step="1"
                                    :class="inputClass()"
                ...
                >
                    ...
                    <div class="space-y-1">
                        ...
                        ></textarea>
                        <p class="text-xs text-muted-foreground">
                            Enter numbers in E.164 format, separated by commas.
                            Uses Semaphore API.
                        </p>
                    </div>
                    <button
                ...
                >
                    <div class="mb-6 flex items-center gap-2">
                        ...
                        <div>
                            <h2 class="font-semibold text-muted-foreground">
                                LED GROW LIGHT SCHEDULE
                            </h2>
                            <p class="text-xs text-muted-foreground">
                                LED runs on schedule during Fruiting stage only.
                                Colonization keeps lights off.
                            </p>
                        </div>
                    </div>
                    <div class="grid max-w-md gap-4 md:grid-cols-2">
                        <div class="space-y-1">
                            <label
                                for="sched-on"
                                class="text-xs font-medium tracking-wider text-muted-foreground uppercase"
                            ...
                            <input
                                id="sched-on"
                                v-model="settingsForm.led_on_hour"
                                type="number"
                                min="0"
                                max="23"
                                :class="inputClass()"
                        ...
                        <div class="space-y-1">
                            ...
                            <input
                                id="sched-off"
                                v-model="settingsForm.led_off_hour"
                                type="number"
                                min="0"
                                max="23"
                                :class="inputClass()"
                    ...
                    <p class="mt-2 text-sm text-muted-foreground">
                        Lights ON at {{ settingsForm.led_on_hour ?? 6 }}:00 and
                        OFF at {{ settingsForm.led_off_hour ?? 18 }}:00 daily
                        (for fruiting photoperiod).
                    </p>
                    <button
                ...
                >
                    <div class="mb-6 flex items-center gap-2">
                        <div
                            class="rounded-lg bg-secondary/60 p-2 text-muted-foreground shadow-inner"
                        >
                    ...
                    <div class="max-w-md space-y-4">
                        <div class="space-y-1">
                            ...
                            <input
                                ...
                                type="text"
                                :class="inputClass()"
                                placeholder="IoT Mushroom Monitoring System"
                            />
                        </div>
                    </div>
                    <button
