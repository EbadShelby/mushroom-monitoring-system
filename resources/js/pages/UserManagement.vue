...
const editForm = ref<{ name: string; role: string; contact_number: string }>({
    name: '',
    role: '',
    contact_number: '',
});
    ...
    >
        ...
        >
            ...
            <template v-else>
                ...
                <div
                    v-if="showCreateForm"
                    class="rounded-2xl border border-primary/30 bg-card/80 p-6 shadow-md backdrop-blur-md"
                >
                ...
                <!-- Users List -->
                <div
                    class="overflow-x-auto rounded-2xl border border-border/50 bg-card/60 backdrop-blur-md"
                >
                    <table
                        class="w-full text-left text-sm text-muted-foreground"
                    >
                        <thead
                            class="bg-muted/50 text-xs text-foreground uppercase"
                        >
                            <tr>
                                ...
                                <td class="px-4 py-3 text-right">
                                    ...
                                    >
                                        <button
                                            @click="saveUser(u)"
                                            :disabled="saving"
                                            class="rounded p-1 text-emerald-500 hover:bg-emerald-500/10"
                                        >
                                            <Check class="h-4 w-4" />
                                        </button>
                                        <button
